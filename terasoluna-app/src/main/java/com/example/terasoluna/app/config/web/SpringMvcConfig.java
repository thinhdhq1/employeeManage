package com.example.terasoluna.app.config.web;
 ...
 * Configure SpringMVC.
 */
@ComponentScan(basePackages = {"com.example.terasoluna.app.app"})
...
public class SpringMvcConfig implements WebMvcConfigurer {
     ...
     * @see com.example.terasoluna.app.config.app.ApplicationContext#exceptionCodeResolver()
